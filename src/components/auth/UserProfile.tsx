...
const profileFormSchema = z.object({
  ...
  if (data.newPassword && !data.currentPassword) {
    return false; // If new password is set, current password is required
  }
  return true;
}, {
...
export function UserProfile() {
  ...
  const handleLanguageChange = (newLang: Language) => {
    setLanguage(newLang);
    // AuthContext's updateUser will be called by LanguageContext
  };
  ...
  const onSubmit = (values: z.infer<typeof profileFormSchema>) => {
    ...
    form.reset({ // Reset password fields
        ...form.getValues(),
        currentPassword: "",
        newPassword: "",
        confirmNewPassword: "",
